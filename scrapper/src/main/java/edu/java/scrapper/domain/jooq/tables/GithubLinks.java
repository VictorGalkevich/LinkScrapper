...
public class GithubLinks extends TableImpl<GithubLinksRecord> {
     ...
     */
    public final TableField<GithubLinksRecord, Long> ID = createField(DSL.name("ID"), SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>GITHUB_LINKS.DEFAULT_BRANCH</code>.
     */
    public final TableField<GithubLinksRecord, String> DEFAULT_BRANCH = createField(DSL.name("DEFAULT_BRANCH"), SQLDataType.VARCHAR(64), this, "");

    /**
     * The column <code>GITHUB_LINKS.FORKS_COUNT</code>.
     */
    public final TableField<GithubLinksRecord, Long> FORKS_COUNT = createField(DSL.name("FORKS_COUNT"), SQLDataType.BIGINT, this, "");
